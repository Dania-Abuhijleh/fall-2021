...
;  (synthesize
;    #:forall (list x)
;    #:guarantee (assert (= (interpret sketch2) (interpret (mul z x))))))
...
(define (len l)
  (if (null? l) 0 (+ 1 (len (list-tail l 1)))))
(define (app l1 l2)
  (if (null? l1) l2 (cons (list-ref l1 0) (app (list-tail l1 1) l2))))
(define (rev l)
  (if (null? l) null (app (rev (list-tail l 1)) (list (list-ref l 0)))))
